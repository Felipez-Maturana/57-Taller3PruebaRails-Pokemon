...
class PokemonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pokemon" do
    assert_difference('Pokemon.count') do
      post pokemons_url, params: { pokemon: { description: @pokemon.description, nombre: @pokemon.nombre } }
    end
  ...
  test "should update pokemon" do
    patch pokemon_url(@pokemon), params: { pokemon: { description: @pokemon.description, nombre: @pokemon.nombre } }
